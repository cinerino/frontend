...
function createQRCode(params) {
    ...
    else if (environment.PRINT_QRCODE_TYPE === _models__WEBPACK_IMPORTED_MODULE_5__["Order"].Print.PrintQrcodeType.Admission) {
        // 入場
...
function createPaymentMethodFromType(args) {
    switch (args.paymentMethodType) {
        case _cinerino_sdk__WEBPACK_IMPORTED_MODULE_0__["factory"].paymentMethodType.Cash: {
            return { typeOf: args.paymentMethodType, name: '現金' };
        }
        case _cinerino_sdk__WEBPACK_IMPORTED_MODULE_0__["factory"].paymentMethodType.CreditCard: {
            return { typeOf: args.paymentMethodType, name: 'クレジットカード' };
        }
        case _cinerino_sdk__WEBPACK_IMPORTED_MODULE_0__["factory"].paymentMethodType.EMoney: {
...
(function (PrintQrcodeType) {
    ...
    PrintQrcodeType["Admission"] = "Admission";
...
/*!**************************************!*\
  !*** ./app/models/purchase/index.ts ***!
  \**************************************/
/*! exports provided: MovieTicket, Performance, Screen, Reservation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _performance__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./performance */ "./app/models/purchase/performance.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Performance", function() { return _performance__WEBPACK_IMPORTED_MODULE_1__["Performance"]; });

/* harmony import */ var _reservation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reservation */ "./app/models/purchase/reservation.ts");
/* harmony import */ var _reservation__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_reservation__WEBPACK_IMPORTED_MODULE_2__);
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "Reservation", function() { return _reservation__WEBPACK_IMPORTED_MODULE_2__; });
/* harmony import */ var _screen__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./screen */ "./app/models/purchase/screen.ts");
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "Screen", function() { return _screen__WEBPACK_IMPORTED_MODULE_3__; });
...
class Performance {
    ...
    isSales(params) {
        ...
        const criteria = (params === undefined || params.criteria === undefined)
            ? moment__WEBPACK_IMPORTED_MODULE_0__().unix() : moment__WEBPACK_IMPORTED_MODULE_0__(params.criteria).unix();
        switch (status) {
            case 'start':
                result = !(moment__WEBPACK_IMPORTED_MODULE_0__(offers.validFrom).unix() < criteria);
                break;
            case 'end':
                result = !(moment__WEBPACK_IMPORTED_MODULE_0__(offers.validThrough).unix() > criteria);
                break;
            default:
                result = (moment__WEBPACK_IMPORTED_MODULE_0__(offers.validFrom).unix() < criteria
                    && moment__WEBPACK_IMPORTED_MODULE_0__(offers.validThrough).unix() > criteria);
                break;
        }
        return result;
    }
