...
class AuthIndexComponent {
    ...
    ngOnInit() {
        return __awaiter(this, void 0, void 0, function* () {
            const params = ___WEBPACK_IMPORTED_MODULE_1__["Functions"].Util.getExternalData();
            sessionStorage.setItem('EXTERNAL', JSON.stringify(Object.assign(Object.assign({}, params), { redirectUrl: undefined })));
            const redirectUrl = (params.redirectUrl === undefined) ? undefined : atob(params.redirectUrl);
            yield this.cinerino.signIn({ redirectUrl });
        });
    }
}
AuthIndexComponent.ɵfac = function AuthIndexComponent_Factory(t) { return new (t || AuthIndexComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services__WEBPACK_IMPORTED_MODULE_2__["CinerinoService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthIndexComponent, [{
    ...
    }], function () { return [{ type: _services__WEBPACK_IMPORTED_MODULE_2__["CinerinoService"] }]; }, null); })();
