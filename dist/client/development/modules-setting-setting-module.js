...
/*!*********************************************************************************************************************************************************!*\
  !*** C:/Users/akito/Desktop/workspace/cinerino/frontend/node_modules/raw-loader/dist/cjs.js!./app/modules/setting/pages/setting/setting.component.html ***!
  \*********************************************************************************************************************************************************/
...
var SettingComponent = /** @class */ (function () {
    function SettingComponent(store, utilService, masterService, userService, formBuilder, translate, orderService, router, qrcodeService) {
        this.store = store;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 5];
                    case 5:
                        this.qrcodeService.openQRCodeReader({ cb: function (data) { console.log(data); } });
                        return [2 /*return*/];
                }
            });
        });
    ...
    SettingComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["Store"],
            ...
            _services__WEBPACK_IMPORTED_MODULE_7__["QRCodeService"]])
    ], SettingComponent);
