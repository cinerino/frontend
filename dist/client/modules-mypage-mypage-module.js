...
class MypageAccountComponent {
    ...
    ngOnInit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.sellers = [];
            try {
                this.sellers = yield this.masterService.searchSellers();
                ...
                initialState: {
                    ...
                    cb: (params) => __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            yield this.actionService.user.chargeAccount(Object.assign(Object.assign({}, params), { account,
                                profile,
                                creditCard }));
                            yield this.actionService.user.getAccount();
                ...
                initialState: {
                    ...
                    cb: (params) => __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            yield this.actionService.user.transferAccount(Object.assign(Object.assign({}, params), { account,
                                profile }));
                            yield this.actionService.user.getAccount();
                            this.utilService.openAlert({
                                title: this.translate.instant('common.complete'),
...
MypageIndexComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MypageIndexComponent, selectors: [["app-mypage-index"]], decls: 22, vars: 12, consts: [[1, "contents-width", "mx-auto", "px-3", "py-5"], [1, "text-large", "mb-4", "text-center", "font-weight-bold"], [1, "mb-4", "text-md-center", 3, "innerHTML"], [1, "container", "px-0"], [1, "row"], [1, "col-md-4", "col-12"], ["type", "button", "routerLink", "/mypage/profile", 1, "btn", "btn-primary", "btn-block", "py-3", "mb-3"], [1, "d-block", "mb-2"], [1, "d-block", "text-x-large"], [1, "fas", "fa-user-circle"], ["type", "button", "routerLink", "/mypage/order", 1, "btn", "btn-primary", "btn-block", "py-3", "mb-3"], [1, "fas", "fa-list"]], template: function MypageIndexComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "h2", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipe"](3, "translate");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](3, 4, "mypage.index.title"));
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("innerHTML", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](5, 6, "mypage.index.read"), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeHtml"]);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](7);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](12, 8, "mypage.index.profile"));
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](7);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](19, 10, "mypage.index.order"));
...
function MypageOrderDetailComponent_app_order_detail_6_Template(rf, ctx) { if (rf & 1) {
    ...
    const authorizeOrder_r1 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("order", authorizeOrder_r1.order);
} }
class MypageOrderDetailComponent {
    ...
    ngOnInit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const searchResult = yield this.actionService.order.search({
            ...
            for (const order of searchResult.data) {
                const code = yield this.actionService.order.authorizeOrder({ order });
...
MypageOrderDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MypageOrderDetailComponent, selectors: [["app-mypage-order-detail"]], decls: 11, vars: 10, consts: [[1, "contents-width", "mx-auto", "px-3", "py-5"], [1, "text-large", "mb-4", "text-center", "font-weight-bold"], [1, "mb-4", "text-md-center", 3, "innerHTML"], [3, "order", 4, "ngFor", "ngForOf"], [1, "buttons", "mx-auto", "text-center"], ["type", "button", "routerLink", "/mypage/order", 1, "btn", "btn-outline-primary", "btn-block", "py-3"], [3, "order"]], template: function MypageOrderDetailComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", ctx.authorizeOrders);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
...
class MypageOrderComponent {
    constructor(store, actionServie) {
        this.store = store;
        this.actionServie = actionServie;
    ...
    ngOnInit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.user = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["select"])(_store_reducers__WEBPACK_IMPORTED_MODULE_5__["getUser"]));
            this.isLoading = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["select"])(_store_reducers__WEBPACK_IMPORTED_MODULE_5__["getLoading"]));
            const searchResult = yield this.actionServie.order.search({
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MypageOrderComponent, [{
    ...
    }], function () { return [{ type: _ngrx_store__WEBPACK_IMPORTED_MODULE_1__["Store"] }, { type: _services__WEBPACK_IMPORTED_MODULE_4__["ActionService"] }]; }, null); })();
...
/* harmony import */ var _components_pages_mypage_order_mypage_order_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/pages/mypage-order/mypage-order.component */ "./app/modules/mypage/components/pages/mypage-order/mypage-order.component.ts");
/* harmony import */ var _components_pages_mypage_profile_mypage_profile_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/pages/mypage-profile/mypage-profile.component */ "./app/modules/mypage/components/pages/mypage-profile/mypage-profile.component.ts");
/* harmony import */ var _mypage_routing_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./mypage-routing.module */ "./app/modules/mypage/mypage-routing.module.ts");
...
MypageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function MypageModule_Factory(t) { return new (t || MypageModule)(); }, imports: [[
            ...
            _mypage_routing_module__WEBPACK_IMPORTED_MODULE_9__["MypageRoutingModule"],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](MypageModule, { declarations: [_components_pages_mypage_index_mypage_index_component__WEBPACK_IMPORTED_MODULE_5__["MypageIndexComponent"],
        ...
        _components_pages_mypage_order_detail_mypage_order_detail_component__WEBPACK_IMPORTED_MODULE_6__["MypageOrderDetailComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"],
        _mypage_routing_module__WEBPACK_IMPORTED_MODULE_9__["MypageRoutingModule"],
        _shared_shared_module__WEBPACK_IMPORTED_MODULE_2__["SharedModule"]] }); })();
